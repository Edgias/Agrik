...
{
    public class WorkItemCategoryMapper : IMapper<WorkItemCategory, WorkItemCategoryFormApiModel, WorkItemCategoryApiModel>
    {
        public WorkItemCategory Map(WorkItemCategoryFormApiModel apiModel)
        {
        ...
        public void Map(WorkItemCategory entity, WorkItemCategoryFormApiModel apiModel)
        {
