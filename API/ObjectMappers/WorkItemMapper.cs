...
{
    public class WorkItemMapper : IMapper<WorkItem, WorkItemFormApiModel, WorkItemApiModel>
    {
        public WorkItem Map(WorkItemFormApiModel apiModel)
        {
        ...
        public void Map(WorkItem entity, WorkItemFormApiModel apiModel)
        {
