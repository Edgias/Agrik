...
{
    public class CropMapper : IMapper<Crop, CropFormApiModel, CropApiModel>
    {
        public Crop Map(CropFormApiModel apiModel)
        {
        ...
        public void Map(Crop entity, CropFormApiModel apiModel)
        {
