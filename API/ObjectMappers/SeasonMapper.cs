...
{
    public class SeasonMapper : IMapper<Season, SeasonFormApiModel, SeasonApiModel>
    {
        public Season Map(SeasonFormApiModel apiModel)
        {
        ...
        public void Map(Season entity, SeasonFormApiModel apiModel)
        {
