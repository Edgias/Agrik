...
{
    public class FieldMapper : IMapper<Field, FieldFormApiModel, FieldApiModel>
    {
        public Field Map(FieldFormApiModel apiModel)
        {
        ...
        public void Map(Field entity, FieldFormApiModel apiModel)
        {
