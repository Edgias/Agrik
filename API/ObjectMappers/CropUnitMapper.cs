...
{
    public class CropUnitMapper : IMapper<CropUnit, CropUnitFormApiModel, CropUnitApiModel>
    {
        public CropUnit Map(CropUnitFormApiModel apiModel)
        {
        ...
        public void Map(CropUnit entity, CropUnitFormApiModel apiModel)
        {
