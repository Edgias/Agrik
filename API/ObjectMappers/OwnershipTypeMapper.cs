...
{
    public class OwnershipTypeMapper : IMapper<OwnershipType, OwnershipTypeFormApiModel, OwnershipTypeApiModel>
    {
        public OwnershipType Map(OwnershipTypeFormApiModel apiModel)
        {
        ...
        public void Map(OwnershipType entity, OwnershipTypeFormApiModel apiModel)
        {
