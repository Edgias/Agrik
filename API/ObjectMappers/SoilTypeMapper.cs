...
{
    public class SoilTypeMapper : IMapper<SoilType, SoilTypeFormApiModel, SoilTypeApiModel>
    {
        public SoilType Map(SoilTypeFormApiModel apiModel)
        {
        ...
        public void Map(SoilType entity, SoilTypeFormApiModel apiModel)
        {
