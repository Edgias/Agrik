...
{
    public class CropVarietyMapper : IMapper<CropVariety, CropVarietyFormApiModel, CropVarietyApiModel>
    {
        public CropVariety Map(CropVarietyFormApiModel apiModel)
        {
        ...
        public void Map(CropVariety entity, CropVarietyFormApiModel apiModel)
        {
