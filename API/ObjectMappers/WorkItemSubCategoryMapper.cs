...
{
    public class WorkItemSubCategoryMapper : IMapper<WorkItemSubCategory, WorkItemSubCategoryFormApiModel, WorkItemSubCategoryApiModel>
    {
        public WorkItemSubCategory Map(WorkItemSubCategoryFormApiModel apiModel)
        {
        ...
        public void Map(WorkItemSubCategory entity, WorkItemSubCategoryFormApiModel apiModel)
        {
