...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class SeasonsController : ControllerBase
    {
        ...
        private readonly IMapper<Season, SeasonFormApiModel, SeasonApiModel> _mapper;

        public SeasonsController(IAppLogger<SeasonsController> logger,
            IAsyncRepository<Season> repository,
            IMapper<Season, SeasonFormApiModel, SeasonApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(SeasonFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, SeasonFormApiModel apiModel)
        {
            try
            {
                Season season = await _repository.GetByIdAsync(id);
