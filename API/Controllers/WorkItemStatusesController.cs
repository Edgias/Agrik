...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class WorkItemStatusesController : ControllerBase
    {
        ...
        private readonly IMapper<WorkItemStatus, WorkItemStatusFormApiModel, WorkItemStatusApiModel> _mapper;

        public WorkItemStatusesController(IAppLogger<WorkItemStatusesController> logger,
            IAsyncRepository<WorkItemStatus> repository,
            IMapper<WorkItemStatus, WorkItemStatusFormApiModel, WorkItemStatusApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(WorkItemStatusFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, WorkItemStatusFormApiModel apiModel)
        {
            try
            {
                WorkItemStatus workItemStatus = await _repository.GetByIdAsync(id);
