...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class WorkItemCategoriesController : ControllerBase
    {
        ...
        private readonly IMapper<WorkItemCategory, WorkItemCategoryFormApiModel, WorkItemCategoryApiModel> _mapper;
        ...
        public WorkItemCategoriesController(IAppLogger<WorkItemCategoriesController> logger,
            ...
            IMapper<WorkItemCategory, WorkItemCategoryFormApiModel, WorkItemCategoryApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(WorkItemCategoryFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, WorkItemCategoryFormApiModel apiModel)
        {
            try
            {
                WorkItemCategory workItemCategory = await _repository.GetByIdAsync(id);
