...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class SoilTypesController : ControllerBase
    {
        ...
        private readonly IMapper<SoilType, SoilTypeFormApiModel, SoilTypeApiModel> _mapper;

        public SoilTypesController(IAppLogger<SoilTypesController> logger,
            IAsyncRepository<SoilType> repository,
            IMapper<SoilType, SoilTypeFormApiModel, SoilTypeApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(SoilTypeFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, SoilTypeFormApiModel apiModel)
        {
            try
            {
                SoilType soilType = await _repository.GetByIdAsync(id);
