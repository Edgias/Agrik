...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class LocationsController : ControllerBase
    {
        ...
        private readonly IMapper<Location, LocationFormApiModel, LocationApiModel> _mapper;

        public LocationsController(IAppLogger<LocationsController> logger,
            IAsyncRepository<Location> repository,
            IMapper<Location, LocationFormApiModel, LocationApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(LocationFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, LocationFormApiModel apiModel)
        {
            try
            {
                Location location = await _repository.GetByIdAsync(id);
