...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class CropUnitsController : ControllerBase
    {
        ...
        private readonly IMapper<CropUnit, CropUnitFormApiModel, CropUnitApiModel> _mapper;

        public CropUnitsController(IAppLogger<CropUnitsController> logger,
            IAsyncRepository<CropUnit> repository,
            IMapper<CropUnit, CropUnitFormApiModel, CropUnitApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(CropUnitFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, CropUnitFormApiModel apiModel)
        {
            try
            {
                CropUnit cropUnit = await _repository.GetByIdAsync(id);
