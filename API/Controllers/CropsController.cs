...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class CropsController : ControllerBase
    {
        ...
        private readonly IMapper<Crop, CropFormApiModel, CropApiModel> _mapper;

        public CropsController(IAppLogger<CropsController> logger,
            IAsyncRepository<Crop> repository,
            IMapper<Crop, CropFormApiModel, CropApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(CropFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, CropFormApiModel apiModel)
        {
            try
            {
                Crop crop = await _repository.GetByIdAsync(id);
