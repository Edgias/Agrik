...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class FieldsController : ControllerBase
    {
        ...
        private readonly IMapper<Field, FieldFormApiModel, FieldApiModel> _mapper;

        public FieldsController(IAppLogger<FieldsController> logger,
            IAsyncRepository<Field> repository,
            IMapper<Field, FieldFormApiModel, FieldApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(FieldFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, FieldFormApiModel apiModel)
        {
            try
            {
                Field field = await _repository.GetByIdAsync(id);
