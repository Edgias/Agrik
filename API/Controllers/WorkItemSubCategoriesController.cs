...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class WorkItemSubCategoriesController : ControllerBase
    {
        ...
        private readonly IMapper<WorkItemSubCategory, WorkItemSubCategoryFormApiModel, WorkItemSubCategoryApiModel> _mapper;
        ...
        public WorkItemSubCategoriesController(IAppLogger<WorkItemSubCategoriesController> logger,
            ...
            IMapper<WorkItemSubCategory, WorkItemSubCategoryFormApiModel, WorkItemSubCategoryApiModel> mapper)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Post(WorkItemSubCategoryFormApiModel apiModel)
        {
            try
            {
        ...
        public async Task<IActionResult> Put(Guid id, WorkItemSubCategoryFormApiModel apiModel)
        {
            try
            {
                WorkItemSubCategory workItemSubCategory = await _repository.GetByIdAsync(id);
