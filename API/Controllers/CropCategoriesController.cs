...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class CropCategoriesController : ControllerBase
    {
        ...
        private readonly IMapper<CropCategory, CropCategoryFormApiModel, CropCategoryApiModel> _mapper;

        public CropCategoriesController(IAppLogger<CropCategoriesController> logger,
            IAsyncRepository<CropCategory> repository,
            IMapper<CropCategory, CropCategoryFormApiModel, CropCategoryApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(CropCategoryFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, CropCategoryFormApiModel apiModel)
        {
            try
            {
                CropCategory cropCategory = await _repository.GetByIdAsync(id);
