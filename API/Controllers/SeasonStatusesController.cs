...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class SeasonStatusesController : ControllerBase
    {
        ...
        private readonly IMapper<SeasonStatus, SeasonStatusFormApiModel, SeasonStatusApiModel> _mapper;

        public SeasonStatusesController(IAppLogger<SeasonStatusesController> logger,
            IAsyncRepository<SeasonStatus> repository,
            IMapper<SeasonStatus, SeasonStatusFormApiModel, SeasonStatusApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(SeasonStatusFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, SeasonStatusFormApiModel apiModel)
        {
            try
            {
                SeasonStatus seasonStatus = await _repository.GetByIdAsync(id);
