...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class WorkItemsController : ControllerBase
    {
        ...
        private readonly IMapper<WorkItem, WorkItemFormApiModel, WorkItemApiModel> _mapper;

        public WorkItemsController(IAppLogger<WorkItemsController> logger,
            IAsyncRepository<WorkItem> repository,
            IMapper<WorkItem, WorkItemFormApiModel, WorkItemApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost("work-items")]
        public async Task<IActionResult> Post(WorkItemFormApiModel apiModel)
        {
            try
            {
        ...
        public async Task<IActionResult> Put(Guid id, WorkItemFormApiModel apiModel)
        {
            try
            {
                WorkItem workItem = await _repository.GetByIdAsync(id);
