...
namespace Edgias.Agrik.API.Controllers
{
    ...
    public class OwnershipTypesController : ControllerBase
    {
        ...
        private readonly IMapper<OwnershipType, OwnershipTypeFormApiModel, OwnershipTypeApiModel> _mapper;

        public OwnershipTypesController(IAppLogger<OwnershipTypesController> logger,
            IAsyncRepository<OwnershipType> repository,
            IMapper<OwnershipType, OwnershipTypeFormApiModel, OwnershipTypeApiModel> mapper)
        {
            _logger = logger;
        ...
        [HttpPost]
        public async Task<IActionResult> Post(OwnershipTypeFormApiModel apiModel)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(Guid id, OwnershipTypeFormApiModel apiModel)
        {
            try
            {
                OwnershipType ownershipType = await _repository.GetByIdAsync(id);
